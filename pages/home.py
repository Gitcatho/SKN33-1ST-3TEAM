...
cards = [
    (col1, "🔍", "리콜 조회", "브랜드와 차종을 선택해 리콜 대상 여부를 확인하세요", "리콜 조회하기", "pages/1_리콜조회.py"),
    (col2, "📊", "데이터 분석", "제조사별, 연도별 리콜 현황을 파악하세요", "분석 보기", "pages/2_데이터분석.py"),
    (col3, "📍", "서비스센터", "내 지역 근처 서비스센터를 찾아보세요", "센터 찾기", "pages/3_서비스센터.py"),
    (col4, "📰", "리콜 뉴스", "최신 자동차 리콜 관련 뉴스를 확인하세요", "뉴스 보기", "pages/4_뉴스.py"),
]
