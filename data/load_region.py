...
df = pd.read_csv(r'C:\SKN_AI\SKN33-1ST-3TEAM\data\국토교통부_전국 법정동_20260609.csv', encoding='utf-8')
...
region_df.to_csv(r'C:\SKN_AI\SKN33-1ST-3TEAM\data\region_df.csv', index=False, encoding='utf-8-sig')
